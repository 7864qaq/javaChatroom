...
public class ServerFrame extends JFrame implements ActionListener {
	...
	public ServerFrame() {
		...
		pnlServer.setBackground(new Color(19, 211, 211));
		...
		btnSaveLog.setBackground(Color.pink);
		...
		lblVersionNo = new JLabel("ChatRoomServer");
		...
		pnlUser.setBackground(new Color(19, 211, 211));
		...
		pnlServerInfo.setBackground(new Color(19, 211, 211));
